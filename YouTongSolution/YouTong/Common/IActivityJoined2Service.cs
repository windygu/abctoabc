...
namespace YouTong.Common
{
	...
	public interface IActivityJoined2Service
	{
		...
		/// <returns>返回活动参与实体列表</returns>
		IList<ActivityJoined2> GetActivityJoined2s(Guid activityId, Int32 pageIndex, Int32 pageSize);
		...
		IList<ActivityJoined2> GetDeletedActivities(Guid activityId, Int32 pageIndex, Int32 pageSize);
