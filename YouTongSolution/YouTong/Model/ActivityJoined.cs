...
namespace YouTong.Model
{
	...
	/// <summary>
	/// 表名：ut_ActivityJoined 主键列：ID
	/// </summary>
	[SerializableAttribute()]
	public partial class ActivityJoined : Entity
	{
		...
		{
			return new Table<ActivityJoined>("ut_ActivityJoined");
		}
		...
		public override bool Equals(object obj)
		{
			...
			if ((false == typeof(ActivityJoined).IsAssignableFrom(obj.GetType())))
			{
				return false;
			}
		...
		public class _
		{
			...
			/// 表示选择所有列，与*等同
			/// </summary>
			public static AllField All = new AllField<ActivityJoined>();

			/// <summary>
			/// 字段名：ID - 数据类型：Guid
			/// </summary>
			public static Field ID = new Field<ActivityJoined>("ID");

			/// <summary>
			/// 字段名：AddTime - 数据类型：DateTime
			/// </summary>
			public static Field AddTime = new Field<ActivityJoined>("AddTime");

			/// <summary>
			/// 字段名：UpdateTime - 数据类型：DateTime
			/// </summary>
			public static Field UpdateTime = new Field<ActivityJoined>("UpdateTime");

			/// <summary>
			/// 字段名：IsDeleted - 数据类型：Boolean
			/// </summary>
			public static Field IsDeleted = new Field<ActivityJoined>("IsDeleted");

			/// <summary>
			/// 字段名：ActivityID - 数据类型：Guid
			/// </summary>
			public static Field ActivityID = new Field<ActivityJoined>("ActivityID");

			/// <summary>
			/// 字段名：UserID - 数据类型：Guid
			/// </summary>
			public static Field UserID = new Field<ActivityJoined>("UserID");
