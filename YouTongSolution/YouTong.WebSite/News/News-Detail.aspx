<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="News-Detail.aspx.cs" Inherits="YouTong.WebSite.News.News_Detail" %>
...
<head runat="server">
	...
	<title>
		<%= News.Title %>|优童|越秀越优秀|中国儿童优秀展示平台</title>
						...
						<div class="block2 datuzhanshi">
							<div class="metaxiangxi">
								<h3>
									<%= News.Title %></h3>
								<h4>
									<%= News.AddTime.ToString("yyyy-MM-dd") %><a href="#">浏览（4）</a>
									<a href="#">收藏（3）</a></h4>
								<%= News.Body %>
							</div>
						</div>
