<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FamilyMedia-Detail.aspx.cs" Inherits="YouTong.WebSite.Childs.FamilyMedia_Detail" %>
					...
					<div class="zuopinzhanshi">
						...
						<div class="block2 datuzhanshi">
							<div class="bigimg">
								<% if (Media.FileType == 1) %>
								<% { %>
								<a href="<%= Media.FileUrl %>" title="点击查看作品大图" target="_blank">
									<img src="<%= Media.FileUrl %>" width="480" height="360" border="0" alt="点击查看作品大图" /></a>
								<% } %>
								<% else %>
								<% { %>
								<object width="480" height="360">
									<param name="movie" value="<%= Media.FileUrl %>" />
									<param name="allowFullScreen" value="true" />
									<param name="allowscriptaccess" value="always" />
									<param name="wmode" value="opaque"></param>
									<embed src="<%= Media.FileUrl %>" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" wmode="opaque" width="480" height="360"></embed>
								</object>
								<% } %>
							</div>
							<div class="djan0">
								<h3>
									分享给朋友</h3>
								<input name="" type="text" class="dizhilan" value="http://www.no1child.com/child/familymedia-detail.aspx?id=<%= Media.ID %>" />
