...
namespace YouTong.WebSite.Codes
{
    public class DataCache
    {
        ...
        public static String GetSchoolNameByUserID(Guid userId)
        {
            ...
            if (child != null)
            {
                //Child child = UtFactory.Instance.ChildService.GetFirstChild(UserID);

                var school = DbSchool.Instance.GetSchool(child.SchoolID);
                name = school == null ? string.Empty : school.Name;
            }
