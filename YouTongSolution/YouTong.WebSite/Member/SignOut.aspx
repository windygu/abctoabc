<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignOut.aspx.cs" Inherits="YouTong.WebSite.Member.SignOut" %>
...
<body>
	...
	<div id="container">
		...
		<div class="content">
			<div class="register">
				<h2>
					<span><a href="#">优童首页</a><a>》</a><a class="choose">会员登出</a></span></h2>
			</div>
		</div>
