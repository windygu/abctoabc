<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FamilyMedia-List.aspx.cs" Inherits="YouTong.WebSite.Member.FamilyMedia_List" %>
			...
			<div class="register">
				...
				<div class="information_right">
					...
					<div class="gerenxin">
						<ul>
							<li>
								<a href="#" class="choose"><span class="choose">亲子影像</span></a></li>
							<li>
								<a href="FamilyMedia-Upload.aspx" class="choose"><span class="choose">上传影像</span></a></li>
						</ul>
					</div>
						...
						<asp:Repeater ID="Repeater1" runat="server">
							<ItemTemplate>
								<tr class="color">
									...
									<td>
										<a href='FamilyMedia-Update.aspx?id=<%# Eval("ID") %>' target="_blank">修改</a>
									</td>
									<td>
										<%# Eval("Title") %>
									</td>
