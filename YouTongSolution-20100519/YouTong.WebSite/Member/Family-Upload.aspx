<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Family-Upload.aspx.cs" Inherits="YouTong.WebSite.Member.Family_Upload" %>
...
<head runat="server">
	...
	<script type="text/javascript">
		...
		function tudou_finish(item) {
			...
			$("#Works_File").val(item.id);

			var action = "Works-Upload.aspx?action=video";
			var frm = $("#form1");
			frm.attr("action", action);
...
<body>
	...
	<form id="form2" runat="server" enctype="multipart/form-data" target="iframeUpload">
	<div id="container">
