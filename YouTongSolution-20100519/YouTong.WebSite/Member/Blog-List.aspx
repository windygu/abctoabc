<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Blog-List.aspx.cs" Inherits="YouTong.WebSite.Member.Blog_List" %>
						...
						<asp:Repeater ID="Repeater1" runat="server">
							<ItemTemplate>
								<tr class="color">
									...
									<td>
										<a href="Blog-Update.aspx?id=<%# Eval("ID") %>" target="_blank">修改</a>
									</td>
									<td>
										<%# Eval("Title") %>
									</td>
